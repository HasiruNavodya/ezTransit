...
>>>>>>> 17b341a52827f63b94ef422856e241cd244d17fe
...
//get data from textformfield
  ...
  Widget _buildstopName() {
    return TextFormField(
      controller: stopName,
      decoration:
          InputDecoration(labelText: 'Stop Name', border: OutlineInputBorder()),
  ...
  Widget _buildarrivingTime() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          labelText: 'Arriving Time', border: OutlineInputBorder()),
  ...
  Widget _buildlatitude() {
    return TextFormField(
      controller: latitude,
      decoration:
          InputDecoration(labelText: 'latitude', border: OutlineInputBorder()),
      validator: (String value) {
        if (value.isEmpty) {
  ...
  Widget _buildlongitude() {
    return TextFormField(
      ...
      decoration:
          InputDecoration(labelText: 'longitude', border: OutlineInputBorder()),
      // maxLength: 7,
      validator: (String value) {
        if (value.isEmpty) {
