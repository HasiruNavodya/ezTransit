...
class _BusMapState extends State<BusMap> {
    ...
    return Scaffold(
      ...
      body: Container(
        child: GoogleMap(
          ...
          initialCameraPosition: CameraPosition(target: LatLng(6.844688, 80.015283), zoom: 10.0,),
  ...
  void setMapMarker() async{
    busicon = await BitmapDescriptor.fromAssetImage(ImageConfiguration(size: Size(26,26)), 'assets/bus.png');
  }
