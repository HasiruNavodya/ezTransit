...
/*            Padding(
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection("owners").where('ownerEmail', isEqualTo: bus).snapshots(),
                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(2.0),
                                          child: Text('${document.data()['ownerName']}',
                                            style: TextStyle(
                                              fontSize: 19,
                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(2.0),
                                          child: Text('${document.data()['ownerEmail']}',
                                            style: TextStyle(
                                              fontSize: 19,
                                              fontWeight: FontWeight.bold,
                                            ),
                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(2.0),
                                          child: Text('${document.data()['bizRegNo']}',
                                            style: TextStyle(
                                              fontSize: 19,
                                              fontWeight: FontWeight.bold,
                                            ),
                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(2.0),
                                          child: Text('${document.data()['ownerNIC']}',
                                            style: TextStyle(
                                              fontSize: 19,
                                              fontWeight: FontWeight.bold,
                                            ),
